...
Values ('portrait'), ('wide'), ('aerial'), ('street');

INSERT into mounts (name, frameSize)
Values ('canon ef', 'full frame'),  ('canon ef-s', 'APS-C'), ('nikon f fx', 'full frame'), ('nikon f dx', 'APS-C'), ('sony fe', 'full frame'),  ('sony e', 'APS-C'),  ('fuji x', 'APS-C');

INSERT into users (email, firstName, password, mount, about, profileImgUrl)
Values (
'admin@gmail.com',
'Admin Account',
'123456',
...
INSERT into photos (unsplashId, photographerName, downloadUrl, profileUrl, profileImageUrl, regularUrl, smallUrl, thumbUrl, category)
Values (
'Mn1Uopx7if8',
'Pete Bellis',
...
INSERT into lenses (name, mountId, brand, prime, focalStart, focalEnd, aperatureStart, aperatureEnd, flickrPoolUrl, amazonUrl, ebayUrl)
Values (
'Canon 50mm F1.8 STM',
2,
'Canon',
...
INSERT into user_likes (userId, photoId, liked)
Values (1, 1, true);

INSERT into user_lenses (userId, lensId)
Values (1, 1);

INSERT into lens_reviews (userId, lensId, review, rating)
Values (1, 1, 'The lens is light, quiet, and has incredible build quality.  A vast improvement from the 50MM F1.8 II Nifty Fifty!', 9);
